...
public class PenentuJumlahHari extends javax.swing.JFrame {
    ...
    private void initComponents() {
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(TFtahun, javax.swing.GroupLayout.PREFERRED_SIZE, 102, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGap(42, 42, 42)
                .addComponent(resultLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 309, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        String result = resultLabel.getText(); // Assuming resultLabel contains the result
        try (FileWriter writer = new FileWriter("result.txt")) {
            writer.write(result);
            JOptionPane.showMessageDialog(this, "Result saved to result.txt");
        } catch (IOException e) {
    ...
    private void btnHitungActionPerformed(java.awt.event.ActionEvent evt) {//   
        ...
        String namaBulan = CBbulan.getSelectedItem().toString();
        HitungHari hitungHari = new HitungHari(tahun, namaBulan);
        resultLabel.setText(hitungHari.Hitung());
    }                                         
